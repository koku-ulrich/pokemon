  ...
  <div class="container ">
    ...
    <div class="flex items-center justify-between pt-5">
      ...
      <ul class="shadow-md inline-flex ">
        <li>
          <a v-on:click="setCurrentPage(1)" href="#"
        ...
        <li v-for=" (page,key) in pagination" v-bind:key="key+page">
          <a v-on:click="setCurrentPage(page)" :class="key === 'current'?' text-blue-600 bg-blue-50':'bg-white'"
             aria-current="page"
             class="px-3 py-2 border border-gray-300  hover:bg-blue-100 hover:text-blue-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white"
             v-text="page"></a>
        </li>
        ...
        <li>
          <a v-on:click="setCurrentPage(pages)"
